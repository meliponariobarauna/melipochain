...
ACLOCAL = ${SHELL} "/home/cappelozzi/Área de Trabalho/meliponario/build-aux/missing" aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} "/home/cappelozzi/Área de Trabalho/meliponario/build-aux/missing" autoconf
AUTOHEADER = ${SHELL} "/home/cappelozzi/Área de Trabalho/meliponario/build-aux/missing" autoheader
AUTOMAKE = ${SHELL} "/home/cappelozzi/Área de Trabalho/meliponario/build-aux/missing" automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} "/home/cappelozzi/Área de Trabalho/meliponario/build-aux/missing" makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
abs_builddir = /home/cappelozzi/Área de Trabalho/meliponario
abs_srcdir = /home/cappelozzi/Área de Trabalho/meliponario
abs_top_builddir = /home/cappelozzi/Área de Trabalho/meliponario
abs_top_srcdir = /home/cappelozzi/Área de Trabalho/meliponario
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/home/cappelozzi/Área de Trabalho/meliponario/build-aux/install-sh'
...
# MCHN START
MELIPONARIOD_BIN = $(top_builddir)/src/meliponariod$(EXEEXT)
MELIPONARIOD_COLD_BIN = $(top_builddir)/src/meliponariod-cold$(EXEEXT)
MELIPONARIO_CLI_BIN = $(top_builddir)/src/meliponario-cli$(EXEEXT)
MELIPONARIO_UTIL_BIN = $(top_builddir)/src/meliponario-util$(EXEEXT)
...
$(BITCOIN_WIN_INSTALLER): all-recursive
	...
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MELIPONARIOD_BIN) $(top_builddir)/release    # MCHN
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MELIPONARIOD_COLD_BIN) $(top_builddir)/release    # MCHN
...
$(MELIPONARIOD_BIN): FORCE
	$(MAKE) -C src $(@F)

$(MELIPONARIOD_COLD_BIN): FORCE
	$(MAKE) -C src $(@F)

$(MELIPONARIO_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)

$(MELIPONARIO_UTIL_BIN): FORCE
	$(MAKE) -C src $(@F)
