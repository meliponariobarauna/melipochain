...
#ifndef MELIPONARIO_STATE_H
#define	MELIPONARIO_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/meliponarioscript.h"
...
{    
    const mc_OneBitchainParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_BitchainParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_BitchainParams;
        m_Permissions=NULL;
        m_Assets=NULL;
