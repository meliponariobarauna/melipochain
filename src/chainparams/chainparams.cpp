...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsBitchain =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataBitchain = {
        &mapCheckpointsBitchain,
        0,
        0,
        0
    };
...
class CMeliponariodParams : public CMainParams {
public:
    CMeliponariodParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::MELIPONARIO;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void SetMeliponariodParam(const char*param_name,int64_t value)
    {
    ...
    void SetMeliponariodRuntimeParams()
    {
...
static CMeliponariodParams multiChainParams;


bool SelectMeliponariodParams(const char *NetworkName)
{
    SelectMeliponariodBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));
...
void SetMeliponariodParams()
{
    multiChainParams.SetMeliponariodParams();
}

void SetMeliponariodParam(const char*param_name,int64_t value)
{
    multiChainParams.SetMeliponariodParam(param_name,value);
}


void SetMeliponariodRuntimeParams()
{
    multiChainParams.SetMeliponariodRuntimeParams();
}

bool InitializeMeliponariodParams()
{
