...
class CBaseMeliponariodParams : public CBaseTestNetParams
{
public:
    CBaseMeliponariodParams()
    {
        networkID = CBaseChainParams::MELIPONARIO;
        strDataDir = "meliponario";
    }
...
static CBaseMeliponariodParams multiChainParams;
/* MCHN END */      
...
bool SelectMeliponariodBaseParams(const char *NetworkName,int RPCPort)
{
