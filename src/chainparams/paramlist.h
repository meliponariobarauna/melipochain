...
#ifndef MELIPONARIOPARAMLIST_H
#define MELIPONARIOPARAMLIST_H

static const mc_OneBitchainParam BitchainParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: meliponario (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for meliponariod and meliponario-cli."},                   
