...
bool ParseBitchainTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
...
bool ParseBitchainTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
                                  ...
                                  string& strFailReason)                        // OUT error
{
    return ParseBitchainTxOutToBuffer(hash,txout,amounts,lpScript,allowed,required,NULL,strFailReason);
}
