...
int main(int argc, char* argv[])
{
    ...
    mc_BitchainParams* params;
    mc_BitchainParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running meliponariod for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"meliponariod %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_BitchainParams;
                paramsOld=new mc_BitchainParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  meliponario-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new meliponario configuration file %s with default parameters\n",
        ...
        printf("  meliponario-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new meliponario configuration file %s copying parameters\n",fileName);
