                            ...
                            if(ptr)
                            {
                                ...
                                while(ptr<ptrEnd)
                                {
                                    ...
                                    if(param.m_Param)
                                    {
                                        ...
                                        if(vUpgrades == NULL)                   // Called from BitchainNode_ApplyUpgrades
                                        {
        ...
        if(pool.exists(hash))
        {
            ...
            else
            {
                ...
                if(entry.FullReplayRequired())
                {
                    ...
                    if(!AcceptMeliponariodTransaction(tx,view,-1,accept ? MC_AMT_DEFAULT : MC_AMT_NO_ACCEPT,reason,NULL,NULL))
                    {
